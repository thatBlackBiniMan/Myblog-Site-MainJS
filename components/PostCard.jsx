...
console.log(post);
  ...
  return (
    <div className="bg-yellow-400 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <p className="text-center text-lg text-black font-normal px-4 lg:px-20 mb-8">{post.excerpt}</p>
