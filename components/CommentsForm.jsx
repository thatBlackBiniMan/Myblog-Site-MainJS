  ...
  return (
    <div className="bg-gray-200 shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        ...
        <label className="text-gray-500 cursor-pointer ml-3" htmlFor="storeData">Save my e-mail and name for the next time i comment</label>
        </div> 
        </div>            
       {error && <p className="text-xs text-red-500">All fields are required to post comments</p>}
     <div className="mt-8">
      <button type="button"
       onClick={handleCommentSubmission}
       className="transition duration-500 ease hover:text-white hover:bg-yellow-600 inline-block bg-yellow-400 text-lg rounded-full text-black px-8 py-3 cursor-pointer">
       Post Comment
      </button>
